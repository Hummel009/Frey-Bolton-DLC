...
public class FBEntityBoltonSoldier extends FBEntityBoltonLevyman {
	public FBEntityBoltonSoldier(World world) {
		super(world);
		spawnRidingHorse = rand.nextInt(6) == 0;
		npcShield = FBShields.BOLTON;
	}
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData data) {
		...
		setCurrentItemOrArmor(1, new ItemStack(GOT.northBoots));
		setCurrentItemOrArmor(2, new ItemStack(GOT.northLeggings));
		setCurrentItemOrArmor(3, new ItemStack(GOT.northChestplate));
		setCurrentItemOrArmor(4, new ItemStack(GOT.northHelmet));
		return data;
	}
